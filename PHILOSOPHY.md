...
## North Star
Advance intermem through small, testable changes aligned to its core mission: Memory synthesis — graduates stable auto-memory facts to AGENTS.md/CLAUDE.md
